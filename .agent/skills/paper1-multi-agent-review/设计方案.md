...
## 4A. p3-microservice 专版（本仓库默认）

> **各角色具体勾选步骤**以 [审核细则.md](审核细则.md) 为准；本节保留 Phase 流程骨架。  
> 路径见 [config.md](config.md)；预检种子见 [已知问题清单.md](已知问题清单.md)（C1–C5）。

| Phase | p3 要点 |
|-------|---------|
| 0 | 列 `latex/sections/zh/*.tex`；读 `phase3_latest.json`；双主稿 MD+LaTeX |
| 1 | **先** `grep ±1000`、`grep 首期`；核对 C3 |
| 2 | 五角色按审核细则 §2–§6，Issue 带 L0 字段 |
| 3 | CL-FAIR / CL-SIGMA / CL-SYNC（审核细则 §7） |
| 4–5 | P0≤7；行动清单含「需同步文件」（LaTeX+MD+L1） |
| JOS | Phase 1 +J1–J7；`05` 附录投稿外 checklist |

官网 JOS 条文见 [软件学报投稿要点.md](软件学报投稿要点.md)。
